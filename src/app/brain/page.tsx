...
const regions = [
  ...
  },
  {
    ...
    color: 'bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800/40',
  ...
  },
  {
    ...
    color: 'bg-rose-50 dark:bg-rose-950/20 border-rose-200 dark:border-rose-800/40',
